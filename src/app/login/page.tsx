...
// Combined Log in / Sign up page. Both buttons submit the same email + password
// form, but to different actions (formAction).
      ...
      <div className="w-full max-w-sm border border-white/10 rounded-lg p-8 bg-black/20">
        ...
        <div className="mt-4 flex flex-col gap-1 text-sm">
          ...
          <span className="text-white/50">
            New here?{" "}
            <Link href="/signup" className="text-white/80 underline">
              Create an account
            </Link>
          </span>
        </div>
